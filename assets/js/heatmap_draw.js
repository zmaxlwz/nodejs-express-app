...
var createHeatchart = function(attr_name, bkt_num, value_range) {
  ...
  .text(function(d) {
	  var title_text = "";
	  if(d.aggValue == null){
		  //agg value is not defined
		  title_text = title_text + "Aggregation Value: undefined(no data) ";
	  }
	  else{
	  	  //agg value is defined
		  title_text = title_text + "Aggregation Value: " + Math.round(d.aggValue*100)/100;
	  }
