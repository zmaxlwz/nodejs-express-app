...
<head>
  ...
  function getMyScenario(sel) {
    ...
    if (scenario == "Scenario 4" || scenario == "Scenario 5" || scenario == "Scenario 6") {
      html = "<option>sdss</option>";
    }
    else if (scenario == "Scenario 1" || scenario == "Scenario 2") {
      html = "<option>housing</option>";
    }
	else if (scenario == "Scenario 3"){
		html = "<option>housing</option><option>sdss</option>";
	}
    else {
      html = "<option>housing</option><option>sdss</option>";
          ...
          <div class="panel-body">
            ...
            <option>xcn05.cs-i.brandeis.edu</option>            
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="myusername" type="text" class="form-control" id="Username" value="wenzhao" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input name="mypassword" type="password" class="form-control" id="inputPassword" value="CSwenCF" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <select name="myscenario" class="form-control" id="inputScenario" onchange="getMyScenario(this)">
                      ...
                      <option value="Scenario 1">Real Estate Exploration Step-through</option>            
                      <option value="Scenario 2">Comparison to Manual Exploration</option>
                      <option value="Scenario 4">Linear Exploration</option>
                      <option value="Scenario 5">Non Linear Exploration</option>
                    </select>
                  </div>
                </div>
